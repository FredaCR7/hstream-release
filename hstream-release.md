...
尽管现在 HStreamDB 尚处在早期的开发阶段，
但也正是各位开源社区的伙伴们一起参与进来的最好时机，
这里我们也诚邀各位一起来建设 HStreamDB 的开源社区。
大家可以通过访问 HStreamDB 的网站[链接]，
或者 GitHub 地址来[链接]来了解更多信息，
也欢迎加入我们的 Slack Channel [链接] 来参与讨论。
HStreamDB 后续的分布式处理支持， Schema 管理， SQL 优化，
以及监控和运维等功能正在积极的陆续开发和完善中， 敬请期待！
